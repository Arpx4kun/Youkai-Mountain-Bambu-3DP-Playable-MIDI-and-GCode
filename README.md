...
两年前我发现这个小功能时觉得特别有趣，但很多打印机的音乐演示听起来都有些“单薄”或“嘈杂”。经过一番折腾，我发现关键在于**如何为三个不同的步进电机分配合适的音轨**。这个仓库就是我折腾出来的、个人认为效果最好的版本，供你参考、把玩和改进。
...
2.  **研究与修改**：
    ...
    *   然后，访问拓竹官方的MIDI项目页面，将你的MIDI导入，重新选择电机分配并生成属于你自己的G-code。
